...
export default function Section() {
  ...
  return (
    <Container
      maxW={"7xl"}
      mt={{ base: "0px", sm: "100px", md: "100px", lg: "70px", xl: "100px" }}
    >
      <Stack
        align={"center"}
      ...
      >
        <Stack flex={1} spacing={{ base: 5, md: 10 }} mx="auto" maxW={1900}>
          <Heading
            lineHeight={1.1}
            fontWeight={600}
        ...
        >
          <Blob
            ...
            left={0}
            zIndex={-1}
            color={useColorModeValue("#050A30", "#050A30")}
          />
          <Box
            position={"relative"}
            height={"auto"}
